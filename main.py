...
class Formation():
    ...
    def formMove(self):
        ...
        if self.pos[0]>=(600-(self.size[0]*self.file.char_distance_x)): 
    ...
    #this is a fancy little thing where the formation flies off screen and gives you no points
    def exit(self):
